...
export const passSeoDetails: Record<string, PassSeoDetails> = {
  ...
  'paso-los-libertadores': {
    ...
    aboutPass: 'Paso Los Libertadores (also known as Paso del Cristo Redentor) is the most critical international highway mountain pass crossing the high Andes between central Chile (Valparaíso Region) and Argentina (Mendoza Province). Reaching an elevation of 10,499 feet (3,200 m) at the international tunnel portal, it carries heavy international trade and passenger transit between Santiago and Buenos Aires. The Chilean approach features the famous Los Caracoles—a steep sequence of 29 unbanked hairpin turns climbing directly up the mountain face without guardrails.',
